...
class RegistrationPage(BasePage):
    ...
    def __init__(self, page):
        ...
        self.user_name_field = self.page.locator(self.page_locators.user_name)
        self.last_name_field = self.page.locator(self.page_locators.last_name)
        self.email_field = self.page.locator(self.page_locators.email)
        self.password_field = self.page.locator(self.page_locators.user_pwd)
        self.reenter_password_field = self.page.locator(self.page_locators.user_reenter_pwd)
        self.register_button = self.page.locator(self.page_locators.registering_button)
    ...
    def required_fields(self):
        ...
        assert self.user_name_field.get_attribute('required') is not None
        assert self.last_name_field.get_attribute('required') is not None
        assert self.email_field.get_attribute('required') is not None
        assert self.password_field.get_attribute('required') is not None
        assert self.reenter_password_field.get_attribute('required') is not None
